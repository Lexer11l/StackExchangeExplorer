...
public abstract class TestConstantStrings {
    ...
    public final static String GET_FULL_REQUEST_URL ="http://api.stackexchange.com/2.2/search?site=stackoverflow&intitle=java&sort=activity&order=desc&page=1&pagesize=10&fromdate=-10800&todate=75600";
    public final static String ERROR_RESPONSE = "Did not received response from service.<br>There were some problems with query <br>Response have status:null";
